...
// var options, chart, linechartcustomerColors = ["rgb(221,63,235)", "#8179dc", "#8179dc"], // Define your colors here
//     chartDonutBasicColors = (linechartcustomerColors && (options = {
//         series: [{
//             name: "Appointments",
//             type: "area",
...
var linechartcustomerColors = ["#8179dc", "#dd3feb"], // Define your gradient colors here
    chartDonutBasicColors = (linechartcustomerColors && (options = {
        series: [{
            name: "Appointments",
            type: "area",
        ...
        chart: {
            ...
            events: {
                mounted: function (chartContext, config) {
                    var ctx = chartContext.ctx;
                    var gradient = createGradient(ctx, linechartcustomerColors);
                    chartContext.updateOptions({
                        colors: [gradient, gradient, gradient]
                    });
                }
            }
        },
