                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-7 py-5 mx-auto">
                                        <div class="text-center">
                                            ...
                                            <h5 class="text-brand">Kimih for Customers </h5>
                                            <p class="text-muted" id="createP">Create an account or log in to book and
                                            ...
                                            <form class="needs-validation" id="form1">
                                                ...
                                                <div class="loginWith">
                                                    <button type="button" class=" waves-effect waves-light"><a
                                                            href="/socialite/facebook/customer" class="text-dark"><img
                                                                class="img-fluid"
                                                                src="{{ asset('dash-assets/images/facebook.svg') }}">
                                                            </i>Continue with Facebook</a></button>
                                                    <button type="button" class=" waves-effect waves-light"><a
                                                            href="/socialite/google/customer" class="text-dark"><img
                                                                class="img-fluid"
                                                                src="{{ asset('dash-assets/images/google.svg') }}">Continue
                                                            with Google
                                                        </a></button>
                                                    {{-- <button type="button" class=" waves-effect waves-light"><a
                                                            href="/socialite/apple/customer" class="text-dark"><img
                                                                class="img-fluid"
                                                ...
                                                <p class="text-center"><a href="{{ route('auth-for-business') }}"
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            if (response.role == 'Client') {
                                ...
                                $('#spanName').show();
                                $('#spanEmailp').show();
                                $('#spanName').text('Welcome back to your customer account, ' +
                                    response.name);
                            ...
                            window.location.href = `/auth/sign-up/for-customer/${emailValue}`;
                        }
