                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        ...
                                        data-bs-toggle="modal" class="btn btn btn-success add-btn rounded-3 mt-2" >Add Brand <i class="bi bi-plus-lg"></i>
                                        </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn default-btn me-2 text-white">Submit</button>
