                        ...
                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control mt-2"
                                                    name="product_short_description" id="product_short_description"
                                                    placeholder="">
                                            </div>
                            ...
                            <div class="card rounded-3 mt-4">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mt-2">
                                                <input type="checkbox" name="retail_sales" id="retail_sales"
                                                    value="1">
                                    ...
                                    <div class="p-3" id="retail-option-commission" style="display: none">
                                        ...
                                        <h6 class="text-secondary">Calculate team member commission when the product is
                                            sold.
                                        </h6>
                                        <!--end breadcrumb-->
                                        <div class="row mt-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4 track-div">
                                        <h6>Low stock and reordering </h1>
                                            <span class="text-secondary">Fresha will automatically notify you and pre-fill
                                                the
                                                reorder quantity set for future stock orders</span>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="order_tax">Low stock level</label>
                                                    <input type="number" class="form-control subheading "
                                                        placeholder="0" id="low_stock_level" name="low_stock_level" />
                                                    <span class="text-secondary">The level to get notified to
                                                        reorder</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control subheading "
                                                        placeholder="0" id="reorder_quantity" name="reorder_quantity" />
                            ...
                            <div class="card rounded-3 mt-4">
                                <div class="card-body" id="barcodeSection">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mt-1 subheading">
                                                <input type="text" class="form-control subheading"
                                                    placeholder="Barcode" aria-label="Recipient's username"
                                                    aria-describedby="basic-addon2" name="productCode1"
                                                    id="productCode" />
                                    ...
                                    <div class="row mt-4 bg-light align-middle p-3 rounded-3 mx-1"
                                ...
                                <div class="card-body upload__box">
                                    <div class="file-upload upload__btn-box">
                                        <label class="upload__btn">
                                            <img src="{{ asset('assets_old/dasheets/img/upload-btn.svg') }}"
                                                class="img-fluid" alt="">
...
@section('scripts')
    <script src="{{ asset('assets_old/dasheets/js/main.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets_old/js/image-uploader.js') }}"></script>
