...
@section('title', 'Create Plan Services')
@section('content')
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Create Plan Services</h4>
                    </div><!-- end card header -->

                    <div class="card-body">
                        <form action="{{ route('plan_services.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-lg-6">
