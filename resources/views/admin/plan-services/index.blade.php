            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">All plans services</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('plan_services.create') }}"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">
                                            Create Services <i class="bi bi-plus-lg"></i>
                                        </a>
                                        <a href="{{ route('plans.index') }}"
                                            class="btn btn btn-outline-primary add-btn rounded-3 ms-2 mt-2">
                                            Back
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="{{ route('plan_services.edit', $obj?->id) }}"
