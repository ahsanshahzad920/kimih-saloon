            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">All Blog Types</h4>
                    </div><!-- end card header -->
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('blog-types.create') }}"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">Create Blog Type <i
