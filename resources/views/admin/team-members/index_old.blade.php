                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                            ...
                            <a href="" class="btn import-customer-btn rounded-3 mt-2">
                                Export File
                            </a>
                            ...
                            <a type="button" class="btn import-customer-btn rounded-3 mt-2" data-bs-toggle="modal"
                                data-bs-target="#importfilemodal">Import Client <i class="bi bi-download"></i></a>
                            <a href="{{route('team-members.create')}}" class="btn create-btn rounded-3 mt-2" >Create <i class="bi bi-plus-lg"></i></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td class="align-middle">
                                        <div class="" style="overflow: visible">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a href="{{route('team-members.edit',$user->id)}}" class=" dropdown-item"
                                                    style="cursor: pointer">

                                                    <img src="{{asset('assets/dasheets/img/menu.svg')}}" class="img-fluid me-2"
                                                        alt="" />
                                                    Edit Member
                                                </a>
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <form action="{{ route('team-members.destroy', $user->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <img src="{{asset('assets/dasheets/img/menu.svg')}}" class="img-fluid me-1"
                                                            alt="" />
