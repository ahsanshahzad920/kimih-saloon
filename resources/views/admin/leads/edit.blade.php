            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Edit Lead</h4>
                    </div><!-- end card header -->
                        ...
                        <form action="{{ route('leads.update', $lead->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" id="address" name="address"
                                    rows="3" placeholder="Address">{{ old('address', $lead->address) }}</textarea>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>

                            <button type="submit" class="btn btn-success add-btn rounded-3 me-2">Update</button>
