            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">All infos</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('business-info.create') }}"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">Add Business info <i
                                        ...
                                        @foreach ($businessInfos as $info)
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    <img src="{{ asset(Storage::url($info->image ?? '')) }}" alt="img"
                                                        width="50" height="50" />
                                                </td>
                                                <td class="productimgname">
                                                    {{ $info->title ?? '' }}
                                                ...
                                                {{-- <td>
                                                    {{ Str::limit($info->description ?? '', 90, '...') }}
                                                </td> --}}

                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="{{ route('business-info.edit', $info?->id) }}"
