                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('feature.page.index') }}"
                                            class="btn btn btn-outline-success add-btn rounded-3 mt-2">
                                            Page Title
                                        </a>
                                        <a href="{{ route('features.create') }}"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">Add features <i
                                        ...
                                        @foreach ($features as $feature)
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    <img src="{{ asset(Storage::url($feature->icon ?? '')) }}"
                                                ...
                                                <td>
                                                    {{ Str::limit($feature->description ?? '', 90, '...') }}
                                                </td>
