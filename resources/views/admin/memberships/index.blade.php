            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">All Membership</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('memberships.create') }}" class="default-btn py-2 px-3 mb-3"> Add Membership</a>
                                ...
                                <table class="table align-middle table-nowrap" id="example">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort">Total Services</th>
                                            <th class="sort">Valid For</th>
                                            <th class="sort">Sessions</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        @forelse ($memberships as $membership)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    @if ($membership->sessions == "Unlimited")
                                                        {{$membership->sessions}}
                                                    @else
                                                        {{ $membership->no_of_session . ' sessions' ?? 'N/A' }}</td>
                                                    @endif
        ...
        $(document).on('click', '.delSubBtn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/catalogues/memberships/${dataId}`,
                        type: 'DELETE',
                        headers: {
