                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                            ...
                            <a href="{{route('memberships.create')}}" class="btn create-btn rounded-3 mt-2" >Create Membership <i class="bi bi-plus-lg"></i>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table " id="example">
                        <thead class="fw-bold">
                            <tr>
                                ...
                                <th class="text-secondary">Total Services</th>
                                <th class="text-secondary">Valid For</th>
                        ...
                        <tbody>
                            @forelse ($memberships as $membership)
                                <tr>
                                    <td class="align-middle">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{ $membership->id }}" />
                                    ...
                                    @php
                                        $services = explode(',', $membership->services);
                                    @endphp
                                    <td class="align-middle">{{ count($services) ?? '' }}</td>
                                    <td class="align-middle">{{ $membership->valid_for ?? 'N/A'}}</td>
                                    <td class="align-middle">{{ $membership->no_of_session.' sessions' ?? 'N/A'}}</td>
                                    <td class="align-middle">{{ $membership->price ?? 'N/A' }}</td>
