...
<body>
                    ...
                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div
                                                class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    <img src="{{ asset('dash-assets/images/users/avatar-2.jpg') }}"
                                            ...
                                            <div
                                                class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    <img src="{{ asset('dash-assets/images/users/avatar-8.jpg') }}"
                                                        class="me-3 rounded-circle avatar-xs flex-shrink-0"
                                                        alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                                    ...
                                    <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            <div class="text-reset notification-item d-block dropdown-item">
                                                <div class="d-flex">
                                                    <img src="{{ asset('dash-assets/images/users/avatar-3.jpg') }}"
                                            ...
                                            <div class="text-reset notification-item d-block dropdown-item">
                                                <div class="d-flex">
                                                    <img src="{{ asset('dash-assets/images/users/avatar-6.jpg') }}"
                                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ isset(auth()->user()->image) ? asset('/storage' . auth()->user()->image) : asset('dash-assets/images/users/avatar-1.jpg') }}"
                                        alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('messenger') }}"><i
    ...
    <!-- Vector map-->
    <script src="{{ asset('dash-assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{ asset('dash-assets/libs/jsvectormap/maps/world-merc.js') }}"></script>
