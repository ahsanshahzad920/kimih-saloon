                    ...
                    <div class="row my-3">
                        <div class="col-md-4 col-12">
                            <div class="input-search position-relative">
                                <input type="text" placeholder="Search Role" class="form-control rounded-3 subheading"
                                    id="custom-filter" />
                        ...
                        <div class="col-md-8 col-12 text-end">
                            ...
                            <a href="{{route('roles.create')}}" class="btn create-btn rounded-3 mt-2" >Create <i class="bi bi-plus-lg"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach ($roles as $key => $role)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a class=" text-decoration-none btn" href="{{route('roles.edit',$role->id)}}">
                                        ...
                                        <a href="javascript:void(0);"
                                            ...
                                            <form class="delete-vendor-form text-decoration-none text-danger" method="POST" action="{{ route('roles.destroy', $role->id) }}" style="display:inline">
                                                @csrf
                                                @method('DELETE')
                                                <img src="{{ asset('assets/dasheets/img/plus-circle.svg') }}" class="p-0" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" alt="" />
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{route('roles.create')}}" class="btn btn-success add-btn"> Add</a>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        {{-- <form class="d-inline " id="destroyForm"> --}}
                                                            <button type="button" class="btn btn-sm btn-danger remove-item-btn delSubBtn" data-id="{{$role->id}}">
                                                                Remove
                                                            </button>
                                                        {{-- </form> --}}
                                                    </div>
