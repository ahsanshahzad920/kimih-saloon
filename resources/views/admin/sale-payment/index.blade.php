                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('sales.create') }}"
                                            class="btn btn-success add-btn mt-2">All Sales <i
                                        ...
                                        @foreach ($payments as $payment)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="#">{{ $payment->sale->id }}
                                                    </a>
                                                </td>
                                                @role('Admin')
                                                    <th class="sort">{{$payment->stripe_id ?? '...'}}</th>
                                                @endrole
                                                <td class="align-middle">{{ $payment->client->name ?? 'N/A' }}</td>
                                                <td class="align-middle">{{ $payment->cashReceiverId->name ?? 'N/A' }}</td>
                                                <td class="align-middle">{{ $payment->type ?? 'N/A' }}</td>
                                                <td class="align-middle">{{ $payment->payment_method ?? 'N/A' }}</td>
                                                <td class="align-middle">{{ $payment->paid_amount ?? '0.00' }}</td>

                                                <td>
                                                    {{-- <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="{{ route('sales.edit', $payment->id) }}"
                                                    ...
                                                    <div class="" style="overflow: visible">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a href="#" class=" dropdown-item" style="cursor: pointer" data-bs-target="#exampleModalToggle"
