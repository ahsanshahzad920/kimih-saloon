                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{$permission->name}}" placeholder="Name" class="form-control">
                            </div>
                        </div>
                        <div class="mt-3 col-md-12">
                            <button type="submit" class="btn btn btn-success add-btn">Submit</button>
                        </div>
