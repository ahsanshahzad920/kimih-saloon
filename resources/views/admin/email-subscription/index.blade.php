...
@section('title', 'Emails Subscription')
<!-- ============================================================== -->
@section('content')
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">All Emails</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a
                                            href="{{ route('send.mails.index') }}"class="btn btn btn-success add-btn rounded-3 mt-2">
                                            Send Mails
                                        </a>
                                ...
                                <table class="table align-middle table-nowrap" id="example">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort">Subscription Date</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($subscriptions as $subscription)
                                            <tr>
                                                <th scope="row">
                                                    <div class="form-check">
                                                        <!-- You can customize this checkbox if needed -->
