                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{ route('plans.create') }}"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">Create Plan <i
                                                class="bi bi-plus-lg"></i>
                                        </a>

                                        <a href="{{ route('plan_services.index') }}"
                                            class="btn btn btn-outline-primary add-btn rounded-3 mt-2 ms-2">
                                            Plan Services
                                        </a>
                                        ...
                                        @foreach ($plans as $plan)
                                            <tr>
                                                ...
                                                <!--                                                 <td class="productimgname">
                                                        <img src="{{ asset(Storage::url($plan->image ?? '')) }}" alt="img"
                                                            width="50" height="50" />
                                                    </td> -->
                                                <td class="productimgname">
                                                    {{ $plan->name ?? '' }}
