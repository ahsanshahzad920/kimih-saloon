            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Stock Orders</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="{{route('stock-orders.create')}}" class="btn btn btn-success add-btn rounded-3 mt-2" >Add <i class="bi bi-plus-lg"></i>
                                        </a>
                                ...
                                <table class="table align-middle table-nowrap" id="example">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort">Expected Date</th>
                                            <th class="sort">Deliverd from</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="{{ route('stock-orders.edit', $order->id) }}"
        ...
        $(document).on('click', '.delSubBtn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/catalogues/stock-orders/${dataId}`,
                        type: 'DELETE',
                        headers: {
