                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add Stock Order</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Add Stock Order</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-shadow rounded-3 border-0 mt-5">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control subheading" type="date" value="{{$stock_order->expected_date ?? ''}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select subheading mt-1"
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}"
                                                    {{ $stock_order->supplier_id == $supplier->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group mt-2">
                                <label for="exampleFormControlSelect1" class="mb-1 fw-bold">Manage products for order
                                </label>
                    ...
                    <div class="card card-shadow rounded-3 border-0 mt-4 p-3">
                        <div class="table-responsive">
                            <table class="table text-center" id="mainTable">
                                ...
                                <tbody>
                                    @foreach ($stock_order->orderItems as $item)
                                        <tr>
                                            <td class="align-middle">{{ $loop->iteration }}</td>
                                            <td class="product_name align-middle">{{ $item->product->name }}</td>
                                            <td class="align-middle">{{ $item->product->barcodes[0]['code'] }}</td>
                                            <td class="product_sell_price align-middle">{{ $item->product->category->name }}
                                            </td>
                                            <td class="align-middle">
                                                <input type="number" id="" class="product_qty border-0 price-input"
                                                    value="{{ $item->product->supply_price }}" min="0" />
                                            </td>
                                            <td class="align-middle">
                                                <div class="quantity d-flex justify-content-center align-items-center">
                                                    ...
                                                    <input type="number" id="quantityInput"
                                                        class="product_qty border-0 qty-input " value="{{ $item->quantity }}"
                                                        min="0" />
                                            ...
                                            <td class="product_price align-middle">{{ $item->subtotal }}</td>
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <a href="#" class="btn btn-plus item-delete"
                                                        data-product='{{ json_encode($item->product) }}'>
                                                        <img src="{{ asset('assets_old/dasheets/img/plus-circle.svg') }}"
                                                            alt="" />
                                                    </a>
                                                </div>
                                            </td>
                    ...
                    <div class="card card-shadow rounded-3 border-0 mt-4 p-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a href="#" data-fees="{{$stock_order->fees ?? ''}}" data-bs-target="#exampleModalToggle" data-bs-toggle="modal"
                                    id="addFeeBtn">Add Fees</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class=" mt-4">
                        ...
                        @forelse ($stock_order->fees as $fee)
                            <div id="fees-container">
                                ...
                                <div class="fee-row row mt-2">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Fee Name</label>
                                            <input type="text" class="form-control subheading fee-name"
                                                name="fee_name[]" id="fee_name" placeholder="service fee" required value="{{$fee->name}}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Fee Amount</label>
                                            <input type="text" class="form-control subheading fee-amount"
                                                name="fee_amount[]" id="fee_amount" placeholder="0.00" required value="{{$fee->amount}}">
                                        </div>
                                    </div>
                                    <div class="col-md-2 mt-4">
                                        <div class="form-group">
                                ...
                                <div class="fee-row row mt-2">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Fee Name</label>
                                            <input type="text" class="form-control subheading fee-name"
                                                name="fee_name[]" id="fee_name" placeholder="service fee" required>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Fee Amount</label>
                                            <input type="text" class="form-control subheading fee-amount"
                                                name="fee_amount[]" id="fee_amount" placeholder="0.00" required>
                                        </div>
                                    </div>
                                    <div class="col-md-2 mt-4">
                                        <div class="form-group">
...
@section('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let prodCount = {{ count($stock_order->orderItems) + 1 ?? 1 }};
                        ...
                        row.innerHTML = `
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="#" class="btn btn-plus item-delete" data-product='${JSON.stringify(ui.item.product)}'>
                                    <img src="{{ asset('assets_old/dasheets/img/plus-circle.svg') }}" alt="" />
                                </a>
                            </div>
                            </td>
                        `;
        ...
        function calculateTotal(fees = {!! json_encode($stock_order->fees ?? null) !!} ) {
            let subtotal = 0;
        ...
        $(document).ready(function() {
            $('#createSaleForm').on('submit', function(e) {
                ...
                $('#mainTable tbody tr').each(function() {
                    let item = {
                        product_id: $(this).find('td:nth-child(8) .item-delete').data('product')
                            .id,
                ...
                $.ajax({
                    url: '{{ route('stock-orders.update',$stock_order->id) }}',
                    type: 'PUT',
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Stock order updated successfully!',
