                                ...
                                <div class="col-sm-auto justify-content-sm-end">
                                    <div>
                                        <a href="#" data-bs-target="#exampleModalToggle" data-bs-toggle="modal"
                                            class="btn btn btn-success add-btn rounded-3 mt-2">Add Feedback <i
                ...
                <div class="modal-body">
                    <form action="{{ route('feedback.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="number" min="0" max="6" class="form-control subheading"
        ...
        <div class="modal fade" id="editCategoryModel{{ $feedback->id }}" aria-hidden="true"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('cutomer.feedback.update', $feedback->id) }}" method="POST"
