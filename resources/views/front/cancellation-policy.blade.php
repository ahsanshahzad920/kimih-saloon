...
@section('title', 'Cancellation Policy | Kimih')
...
<div class="legal-hero-section">
    <div class="container position-relative z-1">
        <span class="legal-badge-pill">
            <i class="fa-solid fa-calendar-xmark"></i> Kimih Legal
        </span>
        <h1 class="display-5 fw-bold mb-3">Cancellation Policy</h1>
        <p class="lead text-light opacity-90 mb-0" style="max-width: 680px;">
            How cancellations, rescheduling, and refunds are handled for bookings made through Kimih.
        </p>
...
<div class="legal-container">
    <div class="container">
        <div class="legal-section-card">
            {!! settings()->cancellation_policy ?? '<p>Our Cancellation Policy will be published here shortly.</p>' !!}
        </div>
    </div>
</div>
