...
@section('title', 'Privacy Policy | Kimih')
...
<div class="legal-hero-section">
    <div class="container position-relative z-1">
        <span class="legal-badge-pill">
            <i class="fa-solid fa-user-shield"></i> Kimih Legal
        </span>
        <h1 class="display-5 fw-bold mb-3">Privacy Policy</h1>
        <p class="lead text-light opacity-90 mb-0" style="max-width: 680px;">
            How Kimih collects, uses, and protects your personal information across our website, apps, and booking services.
        </p>
...
<div class="legal-container">
    <div class="container">
        <div class="legal-section-card">
            {!! settings()->privacy_policy ?? '<p>Our Privacy Policy will be published here shortly.</p>' !!}
        </div>
    </div>
</div>
